...
// Get User Cart Count
$sql = "SELECT COUNT(*) AS count FROM user_cart WHERE user_id = '$user_id'";
$result = mysqli_query($conn, $sql);
$data = mysqli_fetch_assoc($result);
$cart_count = $data['count'];

// Get User Cart
$sql = "SELECT product_id FROM user_cart WHERE user_id = '$user_id'";
$result = mysqli_query($conn, $sql);
$userCart = mysqli_fetch_all($result, MYSQLI_ASSOC);

//echo  '<pre>';
//print_r(array_values($userCart));
//echo '</pre>';
//exit();
...
if (isset($_POST['cart'])) {
    ...
    $sql = "INSERT INTO user_cart (product_id, user_id, quantity) VALUES ('$product_id', '$user_id', '$quantity')";
    $result = mysqli_query($conn, $sql);
    if ($result) {
...
function in_cart($product_id): bool
{
    global $userCart;
                ...
                <div class="social-icons">
                    <ul>
                        <li>
                            ...
                            <?php if ($signed) : ?>
                                <a href="cart.php" class="btn btn-primary text-white rounded-0">My Cart
                                    (<?= $cart_count ?>)</a>
...
<div class="projects section" id="projects">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="section-heading">
                    <h2>Discover Our <em>Items</em> &amp; <span>Products</span></h2>
                    <div class="line-dec"></div>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers eiusmod.</p>
                </div>
            </div>
                    ...
                    <?php foreach ($products as $product) : ?>
                        <div class="item">
                            <img width="430" height="250"
                                 src="<?= $product['image_url'] ?? 'assets/images/projects-01.jpg' ?>" alt="">
                            <div class="down-content d-flex">
                                <h4><?= $product['title'] ?></h4>
                                <div class="mx-auto w-50">

                                    <?php if (in_cart($product['id'])): ?>
                                        <button class="btn disabled btn-info rounded-0">Added Already</button>
                                    <?php else: ?>
                                        ...
                                        <form method="post">
                                            ...
                                            <button type="submit" name="cart" value="add_to_cart"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="more-info">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doers
                                eiusmod tempor
                                incididunt ut labore et dolore dolor dolor sit amet, consectetur adipiscing elit, sed
                                doers eiusmod.
                            </p>
                        </div>
                    </div>
